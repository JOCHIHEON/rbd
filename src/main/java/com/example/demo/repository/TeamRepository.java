...
public interface TeamRepository extends MongoRepository<Team, String>{
	...
	@Query(value="{'team_code' : ?0}", fields = "{ team_code : 1, team_name : 1, team_owner : 1, team_leader : 1, team_director : 1, team_coach : 1, team_address : 1, team_company : 1 }")
	public Team findByTeam(String team_code);
	
	@Query(value = "{}", fields="{ team_code : 1, team_name : 1 }")
